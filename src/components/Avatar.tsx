...
const avatarVariants = cva(
  'relative inline-flex items-center justify-center shrink-0 overflow-hidden border-[2.5px] border-nb-black shadow-brutal-sm bg-nb-yellow text-nb-black font-black',
  {
    variants: {
      size: {
        sm: 'w-8 h-8 text-xs',
